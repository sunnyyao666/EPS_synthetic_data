...
import packages.pythonpipeline.src.aggregator as aggregator
import packages.pythonpipeline.src.generator as generator
import packages.pythonpipeline.src.evaluator as evaluator
from packages.pythonpipeline.src.navigator import Navigator
